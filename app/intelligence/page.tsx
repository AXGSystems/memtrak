  ...
  return (
    <div className="p-6">
          ...
          <Card key={stat.label} glass className="transition-all duration-300 hover:translate-y-[-2px]">
            <div style={{ animation: `slideInUp 0.3s ease-out ${i * 0.06}s both` }}>
              ...
              <div className="text-xl font-extrabold mt-1">
                <AnimatedCounter value={stat.value} prefix={stat.prefix} duration={1800} color={stat.color} />
              </div>
            </div>
          </Card>
        ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <Card glass title="Predictive Churn Scores" subtitle="AI-scored non-renewal risk" accent="#E8923F" detailTitle="Churn Prediction" detailContent={<div><p className="text-xs" style={{ color: "var(--text-muted)" }}>MEMTrak combines email engagement, event attendance, payment behavior, and member type to predict churn. ACU members are weighted 50x due to revenue impact. Scores above 70 predict non-renewal.</p></div>}>
