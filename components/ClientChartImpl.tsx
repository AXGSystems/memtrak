...
import {
  Chart,
  // Controllers — only the chart types this component actually renders
  BarController,
  LineController,
  DoughnutController,
  PieController,
...
// Register ONLY what is used (was `...registerables`, the entire library).
// This trims the chart.js footprint in the shared client chunk substantially.
Chart.register(
  BarController,
  LineController,
  DoughnutController,
